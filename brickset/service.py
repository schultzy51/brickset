...
class Brickset:
  ...
  def sets_page(self, page_size=250, page_number=1, theme=None, order_by=None, action=None, token=None):
  ...
  def sets(self, page_size=250, theme=None, order_by=None, action=None, delay=2):
    items = []
    page_number = 1
    token = None
    ...
    while True:
      sets = self.sets_page(page_size=page_size, page_number=page_number, theme=theme, order_by=order_by, action=action, token=token)
      items.extend(sets)
